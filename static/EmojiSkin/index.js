...
function make_graph() {
  ...
  d3.json(url, function(error, data) {
    ...
    chart.tooltipContent(function(key, y, e, graph) {
        ...
        //var perc = e.series.values[e.pointIndex];
        //old: var yy= parseInt(y.replace(/,/g, ''))
              
              //tooltip_str = '<center><b>'+x+'</b></center>' +'<center>'+ commaSeparateNumber(yy)+'</center>' ;
       ...
       chart.showLegend(true);
        ...
        chart
            ...
            //y data (count) is saved with commas at 1000 for the table format. Remove commas:
